...
module.exports = LightnessPicker;


/**
 * Lightness linear picker
 *
 * @module
 * @constructor
 */
function LightnessPicker(target, options){
...
/** Register shortcuts */
Picker.register('l', LightnessPicker);
Picker.register('lightness', LightnessPicker);



var proto = LightnessPicker.prototype = Object.create(Picker.prototype);
